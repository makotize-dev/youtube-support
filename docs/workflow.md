...
flowchart TD
    ...
    P --> Q
    Q --> R[友人にPages URLを通知]
    R -.採用→友人がYouTubeに投稿.-> S[投稿日・URL・No採番<br/>ステータス=投稿済み]
    S --> T[git commit / push]
```
...
### Step 13: 投稿後の記録（友人がYouTubeに投稿し終えたら）

採用された曲を友人が YouTube にアップロードしたら、以下を記録する。
...
| `YouTube_URL` | 公開された動画のURL |
| `投稿日` | YouTube公開日（YYYY-MM-DD） |
| `ステータス` | `投稿済み` |
